...
int main() {
    int x = 12;
    int* px = &x; // Aquí "px" toma la dirección de memoria de la variable "x" y apunta hacia ella.
    // El asterisco (*) se refiere a crear una variable en términos de dirección
    // de memoria en C+.
